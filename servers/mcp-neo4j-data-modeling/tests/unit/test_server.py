...
class TestNamespacing:
    ...
    async def test_namespace_tool_prefixes(self):
        ...
        for expected_tool in expected_tools:
            assert expected_tool in tools.keys(), f"Expected tool {expected_tool} not found in {list(tools.keys())}"
        ...
        for expected_tool in expected_default_tools:
            assert expected_tool in default_tools.keys(), f"Expected default tool {expected_tool} not found in {list(default_tools.keys())}"
