...
[![Add to Kiro](https://kiro.dev/images/add-to-kiro.svg)](https://kiro.dev/launch/mcp/add?name=mcp-neo4j-cypher&config=%7B%22command%22%3A%22uvx%22%2C%22args%22%3A%5B%22mcp-neo4j-cypher%22%5D%2C%22env%22%3A%7B%22NEO4J_URI%22%3A%22bolt%3A%2F%2Flocalhost%3A7687%22%2C%22NEO4J_USERNAME%22%3A%22neo4j%22%2C%22NEO4J_PASSWORD%22%3A%22your-password%22%7D%7D)
...
To install the Neo4j Cypher MCP server in [Kiro](https://kiro.dev), click the badge at the top of this README or manually add the following to your Kiro MCP config file (`.kiro/settings/mcp.json` or `~/.kiro/settings/mcp.json`):
